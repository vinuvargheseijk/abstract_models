...
def makeChemProto(name='hydra'):
        ...
        Adot.expr=str(gamma)+"*(x0^2/(1+x0^2))-"+str(eta)+"*x0+x1-"+str(epsilon)+"*"+str(theta)+"*x0"
        Bdot.expr="-("+str(gamma)+"*(x0^2/(1+x0^2))-"+str(eta)+"*x0+x1)-"+str(epsilon)+"*"+str(alpha)
...
def main():
    ...
    #moose.element('/model/chem/dend/A').vec.nInit=0.1
    moose.element('/model/chem/dend/A').vec[500].nInit=1000
    moose.element('/model/chem/dend/B').vec[500].nInit=1000
    #moose.element('/model/chem/dend/A').vec[60].nInit=100
    #moose.element('/model/chem/dend/B').vec[60].nInit=100
    storeAvec=[]
    storeBvec=[]
