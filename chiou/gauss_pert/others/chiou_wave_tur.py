...
def makeChemProto(name='hydra'):
        ...
        Adot.expr="-x0+(x0^2/(1+0*x0^2))*x1"
        Bdot.expr="x0-(x0^2/(1+0*x0^2))*x1"
...
def main():
    ...
    A.diffConst=1e-14  #1e-13
    B.diffConst=1e-12  #1e-11
    ...
    moose.element('/model/chem/dend/B').vec.nInit = 2.6
    moose.element('/model/chem/dend/A').vec[500].nInit = 20
    #moose.element('/model/chem/dend/A').vec[500].nInit=0
    #moose.element('/model/chem/dend/A').vec[501].nInit=300
    #moose.element('/model/chem/dend/B').vec[500].nInit=130
    #moose.element('/model/chem/dend/B').vec[501].nInit=130
    ...
    for i in range(1,10000,40):
       moose.start(40)
        ...
        #   moose.element('/model/chem/dend/A').vec[600].n=350
        #   moose.element('/model/chem/dend/A').vec[601].n=350
       avec = moose.vec( '/model/chem/dend/A' ).n
