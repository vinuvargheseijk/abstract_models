...
def makeChemProto(name='hydra'):
        ...
        Adot.expr="0.01*(-x0+92-18.5*((x0*x1)/(1+x0+0.1*x0^2)))"
        Bdot.expr="0.01*(1.5*(-x0+64)-18.5*((x0*x1)/(1+x0+0.1*x0^2)))"
...
#    B.concInit=10
    ...
    moose.element('/model/chem/dend/A').vec[25]. nInit=1
    moose.element('/model/chem/dend/A').vec[25]. nInit=1
    ...
    return bvec,avec,storeAvec,storeBvec

if __name__ == '__main__':
    bvec,avec,storeAvec,storeBvec = main()
